...
export const Login: React.FC = () => {
  ...
  const { signInWithEmail, signInWithGoogle, switchToDemoMode, isDemoMode } = useAuth();
    ...
    <div className="min-h-screen bg-[#090d16] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center z-10 space-y-2">
        ...
        <p className="text-sm text-slate-400">
          Turn your raw business data into structured insights in seconds.
        </p>
      </div>
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-2xl space-y-6">
          ...
          <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800 flex items-center justify-between gap-3">
            <div className="text-xs">
              ...
              <span className="text-slate-400">Explore live interactive reports</span>
            </div>
            <Button size="sm" variant="secondary" onClick={handleDemoSignIn}>
              Demo Sign In
            </Button>
          </div>
